...
<li class="<?php if($_SESSION["menu"]==20) echo "active"; else echo "";?>">

						<a href="indexeci.php">

						<i class="menu-icon fa fa-check"></i>

							<span class="menu-text">รายงานที่ได้รับเงินแล้ว</span>

						</a>

				
                    <li class="<?php if($_SESSION["menu"]==100) echo "active"; else echo "";?>">
						<a href="advanceareplan.php">
							<i class="menu-icon fa fa-address-card"></i>
							<span class="menu-text">AdvanceCarePlan</span>
						</a>
					</li>
