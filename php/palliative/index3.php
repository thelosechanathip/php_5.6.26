...
<div class="page-content" >
	<div class="page-header">
		<span class="blue bolder">
			<h4>ทะเบียนผู้ป่วย โรคไตเรื้อรังระยะสุดท้าย และข้อมูลการเยี่ยมบ้าน</h4>
		</span>
	</div><!-- /.page-header -->
...
$('#load_data').html("<center><br><br><br><i class='ace-icon fa fa-spinner fa-spin orange bigger-300'></i></center>");
	setTimeout(function()
	{
		$('#load_data').load("palliative_view3.php?dt1="+dt1+"&dt2="+dt2+"&dt3="+d3+"&dt4="+d4);
	} , (500));
...
<script type="text/javascript">
    ...
    title: {
        text: 'กราฟแท่งแสดงข้อมูลทะเบียนผู้ป่วยโรคไตเรื้อรังระยะสุดท้ายแยกตาม รพสต.'
    },
    subtitle: {
...
WHERE ov.pdx LIKE 'N185%' AND ov.vstdate BETWEEN '2018-10-01' AND '2099-12-30'GROUP BY zn.rpst_id ORDER BY ov.vstdate DESC ";
