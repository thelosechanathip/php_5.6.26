...
<div class="page-content" >
	<div class="page-header">
		<span class="blue bolder">
			<h4>ทะเบียนผู้ป่วย โรคหลอดเลือดสมอง และข้อมูลการเยี่ยมบ้าน</h4>
		</span>
	</div><!-- /.page-header -->	
		...
		<div class="well well">
			<div class="form-horizontal" role="form">
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<?php include "Serviceunit.php"; ?>
				
					</div>
				</div>
                   <div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> สถานะ : </label>
					<div class="col-sm-2">
						<select class="input-group chosen-select form-control" id="sl_rps1" data-placeholder="เลือกสถานะ...">
							<option value="">  </option>
...
var d4 = document.getElementById("sl_rps1").value;
...
$('#load_data').html("<center><br><br><br><i class='ace-icon fa fa-spinner fa-spin orange bigger-300'></i></center>");
	setTimeout(function()
	{
		$('#load_data').load("palliative_view2.php?dt1="+dt1+"&dt2="+dt2+"&dt3="+d3);
	} , (500));
...
$('#bt_process').click(function(e) {  
	...
	setTimeout(function()
	{
		...
		var dt1 = d1.split('/')[2]+"-"+d1.split('/')[1]+"-"+d1.split('/')[0];
		var dt2 = d2.split('/')[2]+"-"+d2.split('/')[1]+"-"+d2.split('/')[0];
		$('#load_data').load("palliative_view2.php?dt1="+dt1+"&dt2="+dt2+"&dt3="+d3+"&dt4="+d4);
...
<script type="text/javascript">
    ...
    title: {
        text: 'กราฟแท่งแสดงข้อมูลทะเบียนผู้ป่วยโรคหลอดเลือดสมองแยกตาม รพสต.'
    },
    subtitle: {
    ...
    tooltip: {
        pointFormat: 'ผู้ป่วยจำนวนคน: <b>{point.y:.1f} %</b>'
    },
    series: [{
        name: 'Population',
        data: [
...
WHERE (ov.pdx BETWEEN 'I60' AND 'I69' ) AND ov.vstdate BETWEEN '2018-10-01' AND '2099-12-30'GROUP BY zn.rpst_id ORDER BY ov.vstdate DESC ";
