...
WHERE o.icd10 in (\"Z515\") and v.vstdate between '$d1' and '$d2' 
and o.hn not in (select distinct(o.hn) from ovstdiag  o left outer join vn_stat v on v.vn=o.vn where o.icd10 in (\"Z515\") and v.vstdate <='2018-12-01' )";
