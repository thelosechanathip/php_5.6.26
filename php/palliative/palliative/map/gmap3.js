...
;(function ($, undef) {
  ...
  function attachEvents($container, args, sender, id, senders){
    if (args.todo.events || args.todo.onces){
		//deawx
		//var spes = '<div style="color: rgb(255, 255, 255); border-bottom-right-radius: 5px; border-bottom-left-radius: 5px; background-color: rgb(0, 58, 173); width: auto; height: 28px;"><div style="color: rgb(255, 255, 255); padding: 5px; font-weight: normal; float: right;"> <a style="color: rgb(255, 255, 255); font-family: Arial,Tahoma; font-size: 13px; font-weight: bold; word-wrap: break-word; text-decoration: none;" href="http://www.cyberthai.net" target="_blank">power by cyberthai.net</a></div></div>';
	
      var context = {
        id: id,
     //   data: args.todo.data + spes,
		 data: args.todo.data,
        tag: args.todo.tag
      };
    }
