...
Highcharts.chart('container', {
    ...
    title: {
        text: 'ค่าเฉลี่ยผู้ป่วยที่เสียชีวิตใน Palliative Care แยก diag ปี 2018 - 2019 '
    },
    subtitle: {
    ...
    tooltip: {
        pointFormat: 'ค่าเฉี่ลยผู้เสียชีวิต <b>{point.y:.1f} คน</b>'
    },
    series: [{
        name: 'Population',
        data: [
...
WHERE (ov.pdx ='Z515' OR ov.dx0 ='Z515' OR ov.dx1 ='Z515' OR ov.dx2 ='Z515' OR ov.dx3 ='Z515' OR ov.dx4 ='Z515' OR ov.dx5 ='Z515') AND
 pt.death =\"Y\" AND ov.pdx LIKE 'C%' AND ov.vstdate BETWEEN '2018-10-01' AND '2019-10-31' GROUP BY ov.pdx -- ORDER BY ov.vstdate DESC ";
...
Highcharts.chart('container2', {
    ...
    title: {
        text: 'กราฟวงกลมแสดงข้อมูลผู้ป่วยที่ยังมีชีวิตอยู่ แยกตาม Diag ปัจจุบัน'
    },
    tooltip: {
    ...
    plotOptions: {
        pie: {
            ...
            dataLabels: {
                ...
                connectorColor: 'จำนวนผู้ป่วย'
            }
        }
    },
    series: [{
        name: 'จำนวนผู้ป่วยคิดเป็นเปอร์เซ็น',
        data: [
           <?php 
				$sql = "SELECT COUNT(DISTINCT ov.hn) as kk,ov.pdx 
FROM vn_stat ov 
...
LEFT JOIN zbm_rpst_name zn ON zn.rpst_id=zr.rpst_id
WHERE (ov.pdx ='Z515' OR ov.dx0 ='Z515' OR ov.dx1 ='Z515' OR ov.dx2 ='Z515' OR ov.dx3 ='Z515' OR ov.dx4 ='Z515' OR ov.dx5 ='Z515') AND
 pt.death =\"N\" AND ov.pdx LIKE 'C%' AND ov.vstdate BETWEEN '2018-10-01' AND '2019-10-31' GROUP BY ov.pdx -- ORDER BY ov.vstdate DESC ";
				$query=mysqli_query($con,$sql);
				while($result=mysqli_fetch_array($query)){
				?>
