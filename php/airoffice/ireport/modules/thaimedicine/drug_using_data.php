...
where i.vstdate BETWEEN '".$_POST['DateStart']."' AND '". $_POST['DateEnd'] ."' and d.drugcategory not like '%สมุน%' and i.vn  IS NOT NULL
group by d.name
order by cc desc";
...
?>
 <table  class="table table-bordered">
        <thead>
            <tr>
                <th colspan="6"><h2 class="text-center">รายงานจำนวนการใช้ยาแผนปัจจุบันผู้ป่วยนอก </h2>
        ...
        <tbody>
            ...
            if (is_array($query2) && sizeof($query2)) { // ตรวจสอบค่าที่ส่งมาว่าเป็น array หรือไม่
                ...
                ?> <tr>
                    ...
                    <td rowspan="2"></td>
                    <td style="background-color:#666699; color:#ffffff;"><?=$total_sum_price." หน่วย"; ?></td>
                    <td style="background-color:#3366FF; color:#ffffff;"><?=number_format($count_qty, 2, '.', '')." บาท";?></td>
