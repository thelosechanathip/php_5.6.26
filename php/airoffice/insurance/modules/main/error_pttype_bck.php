...
$sql = "SELECT ov.staff,pat.cid,hd.name AS hospdep, CONCAT(hp.hosptype,'',hp.name) AS hosname,CONCAT(pat.pname,pat.fname,' ',pat.lname) AS fullname,vn.vstdate,vn.hn,vn.vn,vn.pttype,vn.hospmain,ou.name AS name_staff ,pt.name AS typename,ov.vsttime FROM vn_stat vn
...
WHERE  vn.vstdate BETWEEN '2022-12-15' AND CURDATE() AND pt.hipdata_code IN('UCS','WEL') AND vn.pttype NOT IN ('29','51','52','40','41','42','43','44','49','13','15','98','56','57','58','59','40','99','17','76','78','97','c1','c2','c3','c4','c5','c6','c7','c8') AND vn.hospmain NOT IN('11098',' ')  ";
...
if ($num > 0) {
    ...
    foreach ($result AS $row) {
       ...
       $lineapi = "WiHqpJkBDDI6s5016vmj3k4nUHj03vpNHr36Z19LONW";
...
.$row['vsttime']."  " . $row["fullname"] . "  ". "  สิทธ์:" . $row['pttype'] . " " . $row['typename']
                ...
                . "  " . $row['hosname'] . "   " . "ผู้ส่งตรวจ:" . $row['name_staff']."  "."staff:". $row['staff']
