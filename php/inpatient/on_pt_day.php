...
include "myclass.php";
$idate = $_POST['idate'];
$idate2 = FormatDateDefault($idate);
$dmy = $idate;
if ($idate == "") {
	$dmy = FormatDateSlash(date("Y-m-d"));
	$idate = $dmy;
	$idate2 = date("Y-m-d");
}
    ...
    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="90%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="25" class="textBlackBold" bgcolor="#FAE9F1" style="border-bottom:1px solid #F3CDDF; border-top:1px solid #F3CDDF;">ยอดคงพยาบาล ประจำวัน</td>
          </tr>
          <tr>
            <td align="left">&nbsp;</td>
          </tr>
          ...
          <tr>
            <td height="25" align="left"><table width="300" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="78" height="25" align="left">ระบุวันที่</td>
                <td width="222" height="25" align="left"><link type="text/css" href="css/ui-lightness/jquery-ui-1.8.10.custom.css" rel="stylesheet" />
          ...
          <tr>
            <td height="25" align="left"><img src="images/printer.png" width="23" height="23" border="0" align="absmiddle" /> <a href="report/on_pt_day_r.php?idate=<?php echo $idate; ?>&i_status=<?php echo $i_status; ?>&ac=p" target="_blank" id="k1">พิมพ์</a>&nbsp;&nbsp;&nbsp;<img src="images/excel.png" width="25" height="25" align="absmiddle" /> <a href="report/on_pt_day_r.php?idate=<?php echo $idate; ?>&i_status=<?php echo $i_status; ?>&ac=e" target="_blank" id="k1">ส่งออกเป็น Excel</a></td>
          </tr>
          <tr>
            <td height="25" align="left">รายงานยอดคงพยาบาล ประจำวันที่ <?php echo FormatDateFull(FormatDateDefault($idate)); ?></td>
          </tr>
          <tr>
