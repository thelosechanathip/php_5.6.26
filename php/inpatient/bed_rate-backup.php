    ...
    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="90%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="25" class="textBlackBold" bgcolor="#FAE9F1" style="border-bottom:1px solid #F3CDDF; border-top:1px solid #F3CDDF;">อัตราการครองเตียง</td>
          </tr>
          <tr>
            <td align="left"><span class="textRedNormal"><font size="+2">กำลังปรับปรุงระบบครับ ขออภัยในความไม่สะดวก กำลังเร่งแก้ปัญหาครับ *-*</font></span>
              <table width="780" border="0" cellspacing="0" cellpadding="0">
              <form method="post" action="bed_rate.php">
                <tr>
          ...
          <tr>
            <td height="25"><img src="images/printer.png" width="23" height="23" border="0" align="absmiddle" /> <a href="report/bed_rate_r.php?year1=<?php echo $year1; ?>&i_status=<?php echo $i_status; ?>&ac=p" target="_blank" id="k1">พิมพ์</a>&nbsp;&nbsp;&nbsp;<img src="images/excel.png" width="25" height="25" align="absmiddle" /> <a href="report/bed_rate_r.php?year1=<?php echo $year1; ?>&i_status=<?php echo $i_status; ?>&ac=e" target="_blank" id="k1">ส่งออกเป็น Excel</a></td>
          </tr>
          <tr>
            <td height="25">รายงานอัตราการครองเตียงประจำปีงบประมาณ <?php echo $year1; ?><br />
              <span class="textRedNormal">จะแสดงข้อมูลเมื่อกรอกข้อมูลครบทุกเวรของแต่ละวันในเดือน ถ้าไม่แสดงข้อมูลแสดงว่ายังกรอกข้อมูลไม่ครบ สามารถตรวจสอบได้ที่หน้าจอ รายงานประจำเดือน</span></td>
          </tr>
          <tr>
            <td><table width="800" border="1" cellspacing="0" cellpadding="0">
              <tr>
				...
				?></td>
                <?php } //end while month ?>
                <td width="60" height="25" align="center" bgcolor="#66FFB3">ปีงบ<br />
                  <?php echo substr($year1, 2, 2); ?><br /></td>
                <td width="60" align="center" bgcolor="#66FFB3">ปีงบ<br /><?php echo substr(($year1 - 1), 2, 2); ?></td>
              </tr>
              <?php
$istart = ($year1 - 544)."10";
